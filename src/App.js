...
function App() {
  ...
  return (
    <>
      <Router>
        <Routes>
          <Route path="/" element={<StudentRoute user={user} />}>
            ...
            {/* Verified*/}
            <Route
              path="/profile/resume/:id"
              element={<ProfilePage user={user} />}
            ></Route>
            {/* internship */}
            <Route
              path="/internship"
              element={<ViewInternship user={user} />}
            ></Route>
            {/* Verified*/}
            {/* Filter */}
            {/* <Route path="/filter" element={<Filter user={user} />}></Route> */}
            {/* Student Routes */}
            <Route
          ...
          <Route path="/" element={<AdminRoute user={user} />}>
            ...
            <Route
              ...
              element={<MarksFile user={user} />}
            ></Route>
            {/* Roadmap */}
            <Route path="/admin/addroadmap" element={<AddRoadmap user={user}/>}></Route>
            <Route
              path="/admin/updateroadmap"
              element={<UpdateRoadmap user={user}/>}
            ></Route>
            <Route path="/admin/showroadmap" element={<ShowRoadmaps user={user}/>}></Route>
            <Route
              path="/admin/roadmap"
              element={<Roadmap user={user} />}
            ></Route>
            <Route
            ...
            <Route
              ...
              element={<AddAcademics user={user} />}
            ></Route>
            {/* Verified*/}
            <Route
