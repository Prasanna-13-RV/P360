            ...
            <div class="w-full md:w-3/12 md:mx-2">
              <div class="bg-white p-3 border-t-4 border-green-400">
                ...
                <div className="flex flex-row justify-between items-center">
                  ...
                  <a
                    href={`/profile/resume/${user.userDetails.regno}`}
                ...
                <ul class="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                  <li class="flex items-center py-3">
                    ...
                    <span class="ml-auto">
                      <span class="ml-auto">{data?.passing_year}</span>
                    </span>
                  </li>
                  <li class="flex items-center py-3">
                    <span>CGPA</span>
              ...
              <div class="bg-white p-3 hover:shadow">
                ...
                <div class="grid">
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">P360 Score</div>
                    <div class="px-4 py-1 text-right">{data?.p360_score}</div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">LeetCode</div>
                    <div class="px-4 py-1 text-right">
                      {data?.leetcode_score}
                    </div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">CodeChef</div>
                    <div class="px-4 py-1 text-right">
                      {data?.codechef_score}
                    </div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">CodeForces</div>
                    <div class="px-4 py-1 text-right">
                      {data?.code_forces_score}
                    </div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">HackerRank</div>
                    <div class="px-4 py-1 text-right">
                      {data?.hackerrank_score}
                    </div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">CodeDivision</div>
                    <div class="px-4 py-1 text-right">
                      {data?.code_division_score}
                    </div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">HackerEarth</div>
                    <div class="px-4 py-1 text-right">
                      {data?.hacker_earth_score}
                    </div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">InterviewBit</div>
                    <div class="px-4 py-1 text-right">
                      {data?.interview_bit_score}
                    </div>
                  </div>
                  <div class="grid grid-cols-2">
                    <div class="px-4 py-1 font-semibold">GeeksForGeeks</div>
                    <div class="px-4 py-1 text-right">
                ...
                <div class="text-gray-700">
                  <div class="grid md:grid-cols-2 text-sm">
                    ...
                    <div class="grid grid-cols-2">
                      ...
                      <div class="px-4 py-2">{data?.contact}</div>
                    </div>
                    <div class="grid grid-cols-2">
                    ...
                    <div class="grid grid-cols-2">
                      ...
                      <div class="px-4 py-2">{data?.paddress}</div>
                    </div>
                    <div class="grid grid-cols-2">
                      <div class="px-4 py-2 font-semibold">Department</div>
                      <div class="px-4 py-2">{data?.dept}</div>
                    </div>
                    <div class="grid grid-cols-2">
                    ...
                    <div class="grid grid-cols-2">
                      <div class="px-4 py-2 font-semibold">Year of Joining</div>
                      <div class="px-4 py-2">{data?.joining_year}</div>
                    </div>
                    <div class="grid grid-cols-2">
                    ...
                    <div class="grid grid-cols-2">
                      <div class="px-4 py-2 font-semibold">Father Number</div>
                      <div class="px-4 py-2">{data?.father_phone}</div>
                    </div>
                    <div class="grid grid-cols-2">
                      <div class="px-4 py-2 font-semibold">Mother Name</div>
                      <div class="px-4 py-2">{data?.mother_name}</div>
                    </div>
                    <div class="grid grid-cols-2">
                      <div class="px-4 py-2 font-semibold">Mother Number</div>
                      <div class="px-4 py-2">{data?.mother_phone}</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-2">
                  <div>
                    <div class="flex items-center space-x-2 font-semibold text-gray-900 leading-8 mb-3">
                      ...
                      <span class="tracking-wide">Internship</span>
                    </div>
                  ...
                  <div class="py-3 sm:order-none order-1">
                    ...
                    <div class="flex flex-col space-y-1">
                      <div class="flex flex-col">
                        <p class="font-semibold text-xs text-gray-700">SSLC</p>
                      ...
                      <div class="flex flex-col">
                        <p class="font-semibold text-xs text-gray-700">HSC</p>
                        <p class="text-sm font-medium">
                          <span class="text-green-700">
                ...
                <div class="grid grid-cols-2">
                  <div>
                    ...
                    {certificateArray.map((e, index) => {
                      return (
                        <>
                          <div class="text-teal-600">{e.certificateName}</div>
                          <div class="text-gray-500 text-xs">
                            <a
                  ...
                  <div>
                    ...
                    {projectArray.map((e, index) => {
                      return (
                        <>
                          <div class="text-teal-600">{e.projects}</div>
                          <div class="">{e.project_description}</div>
                          <div class="text-gray-500 text-xs">
                            {e.project_score}
                          </div>
                        </>
