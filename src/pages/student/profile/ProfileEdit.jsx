...
function ProfileEdit({ user }) {
  ...
  const handleProfileSubmit = (e) => {
    e.preventDefault();
    axios
      .post(`http://localhost:8080/student/update/${studentId}`, sendingData, {
        headers: {
          Authorization: `Bearer ${user.token}`,
        },
      })
                ...
                <div className="grid grid-cols-2">
                  <div>
                    ...
                    <div className="p-5">
                      ...
                      <div>
                        {certificateArray.map((intern, index) => {
                          return (
                            <div
                              key={index}
                              onClick={(e) => {
                                ...
                                console.log(intern);
                                setCertificateArray(
                                  certificateArray.filter((certificate) => {
                                    return (
                            ...
                            >
                              <h1>
                                Certificate Name : {intern.certificateName}
                              </h1>
                              <p className="">
                                <a
                                  target="_blank"
                  ...
                  <div>
                    <div className="flex items-center space-x-2 font-semibold text-gray-900 leading-8 mb-3">
                      ...
                      <span className="tracking-wide">Internship</span>
                    </div>
                    <div className="p-5">
                      <div className="grid grid-cols-2 gap-2 py-4">
                        <input
                      ...
                      <div>
                        {internshipArray.map((intern, index) => {
                          return (
                            <div
                              key={index}
                              onClick={(e) => {
                                ...
                                console.log(intern);
                                setInternshipArray(
                                  internshipArray.filter((internship) => {
                                    return (
                            ...
                            >
                              <h1>
                                internship Name : {intern.internship_name}
                              </h1>
                              <p className="">
                                <a
                                  target="_blank"
                                  href={intern.inernship_description}
                                >
                                  Link
                                </a>
                              </p>
                        ...
                        {projectArray.map((intern, index) => {
                          return (
                            <div
                              ...
                              className="bg-[#efefef] p-3 rounded-lg my-1"
                            >
                              <h1>Project Name : {intern.project_name}</h1>
                              <p className="">
                                Project Description :{" "}
                                {intern.project_description}
                              </p>
                              <p className="">
                                Project Score : {intern.project_score}
                              </p>
                            </div>
                          );
                        })}
